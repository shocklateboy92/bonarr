    ...
    <>
      <Title>
        {show()?.name && season()?.name
          ? `${show()?.name} - ${season()?.name} | Bonarr`
          : "Season Details | Bonarr"}
      </Title>
                      ...
                      >
                        ...
                        <Show when={seasonData().vote_average}>
                          <Chip
                            ...
                            color={
                              seasonData().vote_average! > 7
                                ? "success"
                                : seasonData().vote_average! > 5
                                  ? "primary"
                                  : "default"
                            }
                          />
                        ...
                        <Show when={existingFiles()}>
                          {(() => {
                            const files = existingFiles()!;
                            const availableCount = files.filter(
                              (f) => f.exists,
                            ).length;
